...
var objPeoples = [];
function myFun1() {
    var temp11 = localStorage.getItem("Email");
    var temp22 = localStorage.getItem("Pass1");
    ...
    if (temp22 == pass2 && temp22 != "" && pass2 != "" && temp11 != null && temp22 != " " && pass2 != " " && temp11 != " ") {
        ...
        localStorage.setItem("Cpass", pass2);
...
function myFun() {
    ...
    var temp1 = localStorage.getItem("Email");
    // var temp2 = localStorage.getItem("Pass1");
    var temp2 = localStorage.getItem("Cpass");
    ...
    if (temp1 == email2 && temp2 == pass3) {
        location.replace("./portfolio-main/index.html")
    }
...
//     var ftemp = localStorage.getItem("Email");
//     console.log(ftemp);
//     console.log(femail);
//     if (ftemp != email2) {
